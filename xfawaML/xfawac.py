...
def main():
    parser = argparse.ArgumentParser(description='xfawaPL Compiler')
    parser.add_argument('source', help='Source file (.xf)')
    ...
    if not args.source.endswith('.xf'):
        print("Error: Source file must have .xf extension")
        sys.exit(1)
